...
// SHOW
// GET /drinks/5a7db6c74d55bc51bdf39793
router.get('/drinks/:id', requireToken, (req, res, next) => {
  // req.params.id will be set based on the `:id` in the route
  Drink.findById(req.params.id)
    .then(handle404)
    // if `findById` is succesful, respond with 200 and "drink" JSON
...
// UPDATE
// PATCH /drinks/5a7db6c74d55bc51bdf39793
